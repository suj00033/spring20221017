...
<input type="text" id="supplierIdInput11" placeholder="아이디"> <br>
	...
	<br>
	<button id="btn12">/ex47/sub12 post 요청 : 고객정보 </button>
	
	<br>
	<button id="btn13">/ex47/sub13 post 요청 : 공급자정보 </button> <br>
...
document.querySelector("#btn11").addEventListener("click", function() {
	const id = document.querySelector("#idInput11").value;
	const name = document.querySelector("#nameInput11").value;
	const contactName = document.querySelector("#contactNameInput11").value;
	const address = document.querySelector("#addressInput11").value;
	const city = document.querySelector("#cityInput11").value;
	const postalCode = document.querySelector("#postalCodeInput11").value;
	const country = document.querySelector("#countryInput11").value;
	const phone = document.querySelector("#phoneInput11").value;
