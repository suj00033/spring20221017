...
<br>
	<button id="btn4">/ex40/sub04 get </button>
<br>
	<button id="btn5">/ex40/sub04 post </button>
<br>
	<button class="" id="btn6">/ex40/sub04 put 방식 fetch 요청</button>
<br>
	<button class="" id="btn7">/ex40/sub04 delete 방식 fetch 요청</button>
<br> <br>
	<button id="btn8">/ex40/sub05 get </button>
	<br>	
	<button id="btn9">/ex40/sub05 post </button>
	<br>	
	<button id="btn10">/ex40/sub05 put </button>
	<br>	
	<button id="btn11">/ex40/sub05 delete </button>
	<br>	
...
<script type="text/javascript">
	...
	document.querySelector("#btn3").addEventListener("click", function() {
		// 첫번째 파라미터는 요청경로, 두번째 파라미터는 options(object)
